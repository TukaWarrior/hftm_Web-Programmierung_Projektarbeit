...
<head>
    ...
    <style>
        body {
            background-image: url('../ressources/images/backgrounds/bg_about_nicola.webp');
        }
    </style>
...
<body>
    ...
    <!-- Get Origin Story -->
    <?php $aboutme = file_get_contents('../ressources/documents/about_nicola.html'); ?>
